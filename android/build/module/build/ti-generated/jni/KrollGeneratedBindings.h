	...
	namespace bindings {
		...
		BindEntry* TiModuleBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"net.devloops.AgoraRTC.AgoraRTCModule", ::net::devloops::agorartc::AgoraRTCModule::bindProxy, ::net::devloops::agorartc::AgoraRTCModule::dispose},
				{"net.devloops.AgoraRTC.AgoraVideoView", ::net::devloops::agorartc::agorartc::AgoraVideoView::bindProxy, ::net::devloops::agorartc::agorartc::AgoraVideoView::dispose}
			};
